...
public class TesteApoliceDAO extends TesteDAO {
    ...
    public void teste02() {
        ...
        Apolice ap = new Apolice(new Veiculo("B1234567", 2021, null, null, CategoriaVeiculo.ESPORTIVO),
                new BigDecimal("700"), new BigDecimal("1500"), new BigDecimal("25000"), numero);
        cadastro.incluir((Serializable) ap, numero);
    ...
    public void teste03() {
        ...
        Apolice ap = new Apolice(new Veiculo("C1234567", 2022, null, null, CategoriaVeiculo.BASICO),
                new BigDecimal("300"), new BigDecimal("1100"), new BigDecimal("15000"), numero);
        cadastro.incluir((Serializable) ap, numero);
    ...
    public void teste05() {
        ...
        Apolice ap = new Apolice(new Veiculo("E1234567", 2020, null, null, CategoriaVeiculo.BASICO),
                new BigDecimal("450"), new BigDecimal("1000"), new BigDecimal("18000"), numero);
    ...
    public void teste06() {
        ...
        Apolice ap = new Apolice(new Veiculo("F1234567", 2019, null, null, CategoriaVeiculo.ESPORTIVO),
                new BigDecimal("600"), new BigDecimal("1600"), new BigDecimal("22000"), numero);
        cadastro.incluir((Serializable) ap, numero);
        Assertions.assertFalse(dao.incluir(ap)); // duplicado
    }
    ...
    public void teste07() {
        ...
        Apolice nova = new Apolice(new Veiculo("G1234567", 2018, null, null, CategoriaVeiculo.BASICO),
                new BigDecimal("350"), new BigDecimal("1300"), new BigDecimal("17000"), numero);
        Assertions.assertFalse(dao.alterar(nova)); // ainda não existe
    }
    ...
    public void teste08() {
        ...
        Apolice original = new Apolice(new Veiculo("H1234567", 2017, null, null, CategoriaVeiculo.BASICO),
                new BigDecimal("400"), new BigDecimal("1400"), new BigDecimal("19000"), numero);
        ...
        Apolice nova = new Apolice(new Veiculo("H1234567", 2017, null, null, CategoriaVeiculo.ESPORTIVO),
                new BigDecimal("450"), new BigDecimal("1500"), new BigDecimal("20000"), numero);
