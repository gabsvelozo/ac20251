...
public class TesteSinistroDAO extends TesteDAO{
    ...
    public void teste01() {
        String numero = "S0001";
        Sinistro s = new Sinistro(numero, new Veiculo("Z1234567", 2024, null, null, CategoriaVeiculo.ESPORTIVO),
    ...
    public void teste02() {
        String numero = "S0002";
        Sinistro s = new Sinistro(numero, new Veiculo("Y1234567", 2023, null, null, CategoriaVeiculo.BASICO),
    ...
    public void teste03() {
        String numero = "S0003";
        Sinistro s = new Sinistro(numero, new Veiculo("X1234567", 2022, null, null, CategoriaVeiculo.BASICO),
    ...
    public void teste05() {
        String numero = "S0005";
        Sinistro s = new Sinistro(numero, new Veiculo("W1234567", 2021, null, null, CategoriaVeiculo.BASICO),
    ...
    public void teste06() {
        String numero = "S0006";
        Sinistro s = new Sinistro(numero, new Veiculo("V1234567", 2020, null, null, CategoriaVeiculo.ESPORTIVO),
    ...
    public void teste07() {
        String numero = "S0007";
        Sinistro novo = new Sinistro(numero, new Veiculo("U1234567", 2019, null, null, CategoriaVeiculo.BASICO),
    ...
    public void teste08() {
        String numero = "S0008";
        Sinistro original = new Sinistro(numero, new Veiculo("T1234567", 2018, null, null, CategoriaVeiculo.BASICO),
        ...
        Sinistro novo = new Sinistro(numero, new Veiculo("T1234567", 2018, null, null, CategoriaVeiculo.ESPORTIVO),
